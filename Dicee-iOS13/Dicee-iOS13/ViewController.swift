...
class ViewController: UIViewController {
    ...
    @IBAction func rollingDice(_ sender: UIButton) {
        ...
        let diceArray = [#imageLiteral(resourceName: "DiceOne"),#imageLiteral(resourceName: "DiceTwo"),#imageLiteral(resourceName: "DiceThree"),#imageLiteral(resourceName: "DiceFour"),#imageLiteral(resourceName: "DiceSix"),#imageLiteral(resourceName: "DiceFive")]
